<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomerUpdateWS.aspx.cs" Inherits="WineShop.CustomerUpdateWS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal" style="margin-top: 25px;">
        <div class=" col-md-6">
            <div class="form-group">
                <label for="ratelist">Customer:</label>
                <asp:DropDownList ID="DropDownListCustomer" Style="margin-left: auto; margin-right: auto; text-align: center;" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="DropDownListCustomer_SelectedIndexChanged">
                </asp:DropDownList>
            </div>
        </div>
        <div class=" col-md-6">

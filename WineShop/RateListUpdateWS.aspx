<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RateListUpdateWS.aspx.cs" Inherits="WineShop.RateListUpdateWS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal" style="margin-top: 25px;">
        <div class=" col-md-6">
            <div class="form-group">
                <label for="wine">Select Price:</label>
                <asp:DropDownList ID="DropDownListRateList" Style="margin-left: auto; margin-right: auto; text-align: center;" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="DropDownListRateList_SelectedIndexChanged">
                </asp:DropDownList>
            </div>
        </div>
        <div class=" col-md-6">
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorPrice" ValidationGroup="submit" ControlToValidate="txtPrice" runat="server" ErrorMessage="Please enter price"></asp:RequiredFieldValidator>
            </div>
        </div>
